 ...
 * @author huhailiang(javadeeper@gmail.com)  <br>
...
public class ModRoute extends AbstractRoute{
	...
	/**
	 * user_info.id%16={0~7:user1;8~15:user2}#_%04d
	 * 
	 * @param routeString
	 * @throws Exception
	 */
		...
		if (StringUtils.isNotBlank(routeConfig)) {
			...
			if (routeConfigArr.length >= 2) {
				...
				if(modaArr.length==2){
					...
					String routeRes0 = routeRes[0].replace(SymbolConstant.SYMBOL_OPEN_BRACE, "")
	...
	public String getTableName() {
		...
		return this.getTableNamePrefix()+String.format(this.tableNamePostfixFormat, mod);
